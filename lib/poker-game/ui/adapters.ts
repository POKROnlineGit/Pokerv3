import { GameContext } from "../engine/core/types";
import { getCurrentBet } from "../engine/utils/actions";

/**
 * UI-friendly format of GameContext for component compatibility
 * Simplified structure optimized for UI rendering
 */
export interface GameContextUI {
  gameId: string;
  players: Array<{
    id: string;
    name: string;
...
export function gameContextToUI(ctx: GameContext): GameContextUI {
...
// Backward compatibility alias (in case of cached imports)
export const gameContextToLegacyState = gameContextToUI;
